...
$planningQuery = "SELECT p.type_planning, p.date_depot, p.type_semestre, p.chemin_planning
                  FROM planning p 
                  WHERE p.role_personne = 'etudiant' 
                  AND p.id_personne = ?
...
<head>
    ...
    <title>Planning Étudiant - Université de Djibouti</title>
    <link rel="stylesheet" href="../../../public/assets/css/etudiant_planning.css">
...
<body>
    <div class="dashboard">
        ...
        <aside class="left-side">
            ...
            <ul>
                ...
                <a href="etudiant_planning.php" class="active"><li><i class="bi-calendar"></i> Emploi du temps</li></a>
        ...
        <main class="main-content">
            ...
            <section class="content-section">
                <div class="section-header">
                    <h1><i class="bi-calendar-week"></i> Emplois du temps disponibles</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="filters-container">
                            <div class="filter-group">
                                <label for="semestreFilter"><i class="bi-filter-circle"></i> Semestre</label>
                            ...
                            <div class="filter-group">
                                <label for="typeFilter"><i class="bi-funnel"></i> Type</label>
                            ...
                            <div class="filter-group">
                                <label for="dateFilter"><i class="bi-calendar-range"></i> Période</label>
    ...
    <script src="../../../public/assets/js/planning_etudiant.js"></script>
